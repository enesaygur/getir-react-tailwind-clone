export default function MobileApp() {
  return (
    <div className="container mx-auto mt-7 flex flex-col md:flex-row justify-between items-center bg-primary-brand-color bg-mobile-app md:rounded-lg text-white">
      <div className="flex flex-col gap-y-3 p-10 text-center md:text-left">
        ...
        <nav className="mt-5 flex gap-2 flex-wrap lg:flex-nowrap justify-center">
